...
init_offset $m_slc $s_slc $m_par $s_par $MS_off $rlks $alks
...
def cmd_line_parser():
    ...
    parser.add_argument('--rlks',
                        help='range looks (defaults: 9)',
                        default='9',
                        type=int)
    parser.add_argument('--alks',
                        help='azimuth looks (defaults: 10)',
                        default='10',
                        type=int)
...
EXAMPLE = """Usage:
  ...
  ./stacking2.py /ly/slc /ly/stacking /ly/dem 4 --rlks 9 --alks 10
