...
def cmdLineParse():
    ...
    parser.add_argument('s1_zip', help='Sentinel-1 zip file. e.g., S1A*.zip')
    parser.add_argument(
...
EXAMPLE = """Usage:
  ...
  ./zip2slc.py /ly/S1A_IW_SLC_XXXX.zip /ly/orbits /ly/slc 1
  ./zip2slc.py S1A_IW_SLC_XXXX.zip ./../orbits ./.. 2
