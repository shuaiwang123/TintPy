...
EXAMPLE = """Usage:
  ...
  ./prep_files3.py /ly/stacking /ly/mintpy
...
def main():
    ...
    for ifg in ifg_pairs:
        ...
        if flag:
            # just copy once
            UTM_TO_RDC_path = os.path.join(ifg_dir, 'lookup_table_fine')
        ...
        # copy cor in rdc
        cor = ifg.replace('-', '_') + '.diff_filt.cor'
        ...
        # copy unw in rdc
        unw = ifg.replace('-', '_') + '.diff_filt.unw'
